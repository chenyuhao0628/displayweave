...
从 [`v0.1.0-preview.2`](https://github.com/chenyuhao0628/displayweave/releases/tag/v0.1.0-preview.2) 下载 `DisplayWeave-Preview-0.1-Android.apk`。它是离线 v2 签名 Release APK，无需 Google Play。安装前请验证 `SHA256SUMS.txt` 与[发布检查清单](../docs/release-checklist.zh-CN.md)中的证书指纹。
