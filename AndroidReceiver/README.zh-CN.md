...
从 [`v0.2.1-p4`](https://github.com/chenyuhao0628/displayweave/releases/tag/v0.2.1-p4) 下载 `DisplayWeave-Android.apk`。它是离线 v2 签名 Release APK，无需 Google Play。先把它覆盖安装到现有 `app.opendisplay.android` 包；安装前请验证 `SHA256SUMS.txt` 与[发布检查清单](../docs/release-checklist.zh-CN.md)中的证书指纹。
