...
Bounds are HEVC WiFi 12–100, HEVC USB 20–160, H.264 WiFi 8–60, and H.264 USB 10–100 Mbps. The settings UI filters manual presets using the selected codec and transport; the sender revalidates the value using the negotiated codec and actual transport.
