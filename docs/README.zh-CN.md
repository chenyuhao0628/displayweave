...
- [Android 稳定性与延迟审计](android-stability-latency-audit.zh-CN.md)、[连接 Generation 模型](android-connection-generation.zh-CN.md)、[Protocol V2 协商](android-protocol-v2-negotiation.zh-CN.md)、[Binary Frame Header/分配路径](android-binary-frame-header-v2.zh-CN.md)、[热/功耗指标](android-thermal-power-metrics.zh-CN.md)、[帧尺寸协商](frame-size-negotiation.zh-CN.md)、[Decoder 低延迟选择](android-decoder-low-latency.zh-CN.md)、[WiFi 低延迟 / Surface 帧率](android-wifi-low-latency-surface-frame-rate.zh-CN.md)与 [Drop 原因策略](android-drop-reason-policy.zh-CN.md)
