...
export const copy: Record<Locale, SiteCopy> = {
  ...
  zh: {
    ...
    release: { label: `${releaseTag} 发布`, title: "首次安装，之后原位更新 Mac 与 Android。", intro: "所有文件均由 GitHub 直接分发。旧版本需要先完成这次手动迁移，后续才能自动更新。", warning: "开发分发版——未通过 App Store、Google Play、Developer ID 公证或通用 iOS 签名分发。", checksum: "使用 SHA256SUMS.txt 验证全部下载", assets: zhAssets },
