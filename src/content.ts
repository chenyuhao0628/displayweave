...
export const releaseTag = "v0.2.1-p5"
...
export const copy: Record<Locale, SiteCopy> = {
  en: {
    ...
    release: { label: `${releaseTag} release`, title: "Install once, then update Mac and Android in place.", intro: "Release packages are mirrored as immutable static files through Cloudflare. Android p5 keeps its GitHub in-app update path during this one-time migration.", warning: "Development distribution — no App Store, Google Play, Developer ID notarization, or universal iOS signing.", checksum: "Verify all downloads with SHA256SUMS.txt", assets: enAssets },
  ...
  zh: {
    ...
    release: { label: `${releaseTag} 发布`, title: "首次安装，之后原位更新 Mac 与 Android。", intro: "发布文件通过 Cloudflare 不可变静态镜像分发。Android p5 在这次迁移期间仍保留 GitHub 应用内更新路径。", warning: "开发分发版——未通过 App Store、Google Play、Developer ID 公证或通用 iOS 签名分发。", checksum: "使用 SHA256SUMS.txt 验证全部下载", assets: zhAssets },
